...
Q1list=c(100)
Q2=5
Rlist=c(1000,2500,5000,6000,7000,8000,9000,10000)
K1=3
K2=3
K3=3
M=500
...
for (i in 1:length(Q1list)){
  for (j in 1:length(Rlist)){
    data = synthetic_dataset_creation(Q1list[i],Q2,Rlist[j], K1,K2,K3, alpha_dirichlet=0.1, n_max_zipf=50000, a_zipf=1,n_anchors=2, delta_anchor=0.1, M=M, seed=123,offset_zipf=2.7,vary_by_topic=FALSE, sparsity = TRUE)
    error_tmp=run_experiment(data=data,K1=K1,K2=K2,K3=K3,M=M,error=error_tmp)
...
#write.csv(result_Q,file='tensor_Q2_5_K_3_Q1_100.csv', row.names=FALSE)
result_Q=error_tmp
res = result_Q %>% 
